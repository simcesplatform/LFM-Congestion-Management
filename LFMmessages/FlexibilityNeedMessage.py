...
# Example:
# newMessage = FlexibilityNeedMessage(**{
...
class FlexibilityNeedMessage(AbstractResultMessage):
    """Class containing all the attributes for a FlexibilityNeed message."""

    # message type for these messages
    CLASS_MESSAGE_TYPE = "FlexibilityNeed"
    ...
    def __eq__(self, other: Any) -> bool:
        """Check that two FlexibilityNeedMessages represent the same message."""
        return (
            super().__eq__(other) and
            isinstance(other, FlexibilityNeedMessage) and
    ...
    @classmethod
    def from_json(cls, json_message: Dict[str, Any]) -> Union[FlexibilityNeedMessage, None]:
        if cls.validate_json(json_message):
            return FlexibilityNeedMessage(**json_message)
        return None


FlexibilityNeedMessage.register_to_factory()
