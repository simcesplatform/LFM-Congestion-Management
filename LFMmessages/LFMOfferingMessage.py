...
#                                                                       "kW")})
#
# newMessage2 = LFMOfferingMessage(**{
#     "Type": "LFMOffering",
...
class LFMOfferingMessage(AbstractResultMessage):
    """Class containing all the attributes for an LFMOffering message."""

    # message type for these messages
    CLASS_MESSAGE_TYPE = "LFMOffering"
    ...
    def __eq__(self, other: Any) -> bool:
        """Check that two LFMOfferingMessages represent the same message."""
        return (
            super().__eq__(other) and
            isinstance(other, LFMOfferingMessage) and
    ...
    @classmethod
    def from_json(cls, json_message: Dict[str, Any]) -> Union[LFMOfferingMessage, None]:
        if cls.validate_json(json_message):
            return LFMOfferingMessage(**json_message)
        return None


LFMOfferingMessage.register_to_factory()
